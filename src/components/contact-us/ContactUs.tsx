...
function ContactUs() {
  ...
  return (
    ...
    <section id='contact' className={`${styles.contactUs} ${interFont.className}`}>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos dolore possimus eos quod cupiditate quo temporibus tempora soluta inventore fugiat. <br />
         Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt, minus!</p>

        <div className={styles.contactUsBottomDiv}>

        <div className={styles.contactLeftDiv}>
            <div className={styles.contactLeftDivContainer}>
                <IoIosMail size={24} color={"var(--background-gray)"}/>
            <div className={styles.contactLeftDivText}>
                <h6>Have a question?</h6>
                <h6>I am here to help you</h6>
                <h6>Email me at mahneeraazam@gmail.com</h6>
            </div>
            </div>


            <div className={styles.contactLeftDivContainer}>
            <FaMapMarkerAlt  size={24} color={"var(--background-gray)"}/>
            <div className={styles.contactLeftDivText}>
